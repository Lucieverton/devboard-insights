...
import { RotateCcw, Calendar, FileText, Home, MapPin } from "lucide-react";
  ...
  return (
    <>
      <div className="flex-1 p-4 space-y-5 overflow-y-auto">
        <p className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Filtros</p>
      ...
      <div className="p-4 border-t border-sidebar-border">
        <Button onClick={clearFilters} variant="outline" className="w-full border-primary/30 text-primary hover:bg-primary/10 hover:text-primary">
          <RotateCcw className="w-3.5 h-3.5 mr-2" /> Limpar Filtros
        </Button>
      </div>
    </>
  );
